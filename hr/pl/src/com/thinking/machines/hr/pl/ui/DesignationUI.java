...
{
clearIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"clear_icon.png");
...
logoIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"logo.png");
//addIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"add_icon.png");
//editIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"edit_icon.png");
//cancelIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"cancel_icon.png");
//deleteIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"delete_icon.png");
//pdfIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"pdf_icon.png");
//saveIcon=new ImageIcon("D:"+File.separator+"Some_Thing"+File.separator+"javaProjects"+File.separator+"_hr"+File.separator+"icons"+File.separator+"save_icon.png");
...
searchTextField.setFont(captionFont);
...
designationPanel.setBounds(lm+10,tm+10+40+30+10+10+300+10,565,200);
...
designationTable.getSelectionModel( ).clearSelection( );
}
});
...
{
int rowSelected=designationTable.getSelectedRow( );
try
{
DesignationInterface designation=designationModel.getDesignationAt(rowSelected);
...
if(file.exists( ))
{
int select=JOptionPane.showConfirmDialog(DesignationUI.this,"Replace the existing file with new","Confirmation",JOptionPane.YES_NO_OPTION);
if(select==JOptionPane.NO_OPTION)return;
file.delete( );
}
...
{
JOptionPane.showMessageDialog(this,blException.getPropertyException("title"));
}
}
titleTextField.requestFocus( );
return false;
...
designationModel.delete(this.designation.getCode( ));
